        ...
        days: [
            ...
            { day: "Rest Day", exercises: [] },
            {
                ...
                exercises: [
                    ...
                    { name: weekNum >= 6 ? "Chest-Supported T-Bar Row" : "Chest-Supported Machine Row", sets: weekNum >= 11 ? 4 : (weekNum === 1 ? 2 : 3), warmupSets: weekNum === 1 ? 2 : 3, warmupReps: ["12"], reps: weekNum >= 6 ? "10-12" : "8-10", earlyRPE: weekNum === 1 ? "6-7" : "8-9", lastRPE: weekNum === 1 ? "7-8" : "10", rest: "2-3 min", notes: "Flare elbows out at roughly 45° and squeeze your shoulder blades together hard.", sub1: weekNum >= 6 ? "Chest-Supported Machine Row" : "Chest-Supported T-Bar Row", sub2: "Incline Chest-Supported DB Row" },
                    ...
                    { name: weekNum >= 6 ? "Cable Paused Shrug-In" : "Machine Shrug", sets: weekNum >= 9 ? 3 : (weekNum === 1 ? 2 : 3), warmupSets: weekNum === 1 ? 2 : 3, reps: weekNum >= 6 ? "12-15" : "10-12", earlyRPE: weekNum === 1 ? "7-8" : "8-9", lastRPE: weekNum === 1 ? "8-9" : "10", rest: "1-2 min", notes: "Brief pause at the top and bottom of ROM.", sub1: weekNum >= 6 ? "Machine Shrug" : "Cable Paused Shrug-In", sub2: "DB Shrug" },
